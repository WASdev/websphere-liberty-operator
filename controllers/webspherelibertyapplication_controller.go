...
// +kubebuilder:rbac:groups=core,resources=services;secrets;serviceaccounts;persistentvolumeclaims,verbs=list;watch;create;update;delete,namespace=websphere-liberty-operator
