...
[source,sh]
----
    kubectl apply -f https://raw.githubusercontent.com/WASdev/websphere-liberty-operator/main/deploy/releases/1.0.1/kubectl/websphereliberty-app-crd.yaml
----
...
[source,sh]
----
    curl -L https://raw.githubusercontent.com/WASdev/websphere-liberty-operator/main/deploy/releases/1.0.1/kubectl/websphereliberty-app-rbac-watch-all.yaml \
...
[source,sh]
----
    curl -L https://raw.githubusercontent.com/WASdev/websphere-liberty-operator/main/deploy/releases/1.0.1/kubectl/websphereliberty-app-rbac-watch-another.yaml \
      | sed -e "s/WEBSPHERE_LIBERTY_OPERATOR_NAMESPACE/${OPERATOR_NAMESPACE}/" \
...
[source,sh]
----
    curl -L https://raw.githubusercontent.com/WASdev/websphere-liberty-operator/main/deploy/releases/1.0.1/kubectl/websphereliberty-app-operator.yaml \
      | sed -e "s/WEBSPHERE_LIBERTY_WATCH_NAMESPACE/${WATCH_NAMESPACE}/" \
