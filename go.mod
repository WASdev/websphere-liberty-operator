...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260414181438-9f48f8686e0a
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260414175428-cc6835fc170f
