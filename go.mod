...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260311221800-316facd467e9
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260311221056-8a8861d098d1
