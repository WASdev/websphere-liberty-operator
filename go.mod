...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260107195416-f16aff287c3a
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260107194530-15403b6e6dee
