...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260226212036-cca0cfd04943
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260226201852-552e74418985
