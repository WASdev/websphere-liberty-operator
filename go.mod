...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260303175837-fd15cdb1009b
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260303155923-d80e3e801d75
