...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20251216165446-575d3c417293
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20251215213912-c07305a69d10
