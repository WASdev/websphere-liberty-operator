...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20251204214137-5ca60f4cd9b2
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20251204180254-1ccb32f60589
