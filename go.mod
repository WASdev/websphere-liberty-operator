...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260303203258-16641a6dee0e
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260303201123-3038d6dd5bbe
