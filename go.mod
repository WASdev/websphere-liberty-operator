...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260305154143-33e2ffc69bcd
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260305150808-52185e32fb81
