...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260420143840-267432cbe45d
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260420143612-efbb167e1ffd
