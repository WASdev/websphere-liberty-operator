...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20251205192201-a970b41cd059
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20251205191742-7d2acc4b2262
