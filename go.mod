...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20250704155137-b18331384adf
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20250704151801-4f1bd83ce7a8
