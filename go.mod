...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20250210182032-b0254e33baf6
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20250210192553-e9394f9d5abd
