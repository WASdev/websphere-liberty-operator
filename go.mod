...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20250212151411-686a7038f53a
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20250211222110-1c2aa8f06838
