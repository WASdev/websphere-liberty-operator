...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20250617181305-df8344051429
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20250506201433-fca0e8b82b18
