...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20250307193800-71a4c7520aae
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20250307190830-e8e262e2058a
