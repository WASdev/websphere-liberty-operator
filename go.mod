...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260304191440-f084ca3d083b
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260304180924-c6764ba5f603
