...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260923153822-3604efb6ec98
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260921232539-e73f2ca8ace1
