...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260723143904-69cfc6652dce
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260615131220-51c1586aea3a
