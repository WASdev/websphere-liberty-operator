...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260213170916-200264225f7f
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260213170649-9d1f6697ef77
