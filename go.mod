...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260318201118-3f77d7f796bd
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260409170448-b0ad3a192a77
