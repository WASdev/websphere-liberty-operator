...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20251111233044-2d00b207027e
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20251111221342-5f702d054164
