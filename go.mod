...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20250818203154-d461c8779a23
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20250818180111-eb25c71fcda6
