...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20260304165125-325731922cd4
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20260304163630-049be693ea1b
