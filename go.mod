...
require (
	github.com/OpenLiberty/open-liberty-operator v0.8.1-0.20250514155645-36de060ec9b3
	github.com/application-stacks/runtime-component-operator v1.0.0-20220602-0850.0.20250514153310-36ec029dff66
