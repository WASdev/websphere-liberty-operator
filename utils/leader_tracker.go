...
func GetLeaderTracker(instance *wlv1.WebSphereLibertyApplication, operatorShortName string, leaderTrackerType string, client client.Client) (*common.LockedBufferSecret, *[]LeaderTracker, error) {
