...
type WebSphereLibertyApplicationSpec struct {
	...
	// +operator-sdk:csv:customresourcedefinitions:order=10,type=spec,displayName="Manage Password Encryption",xDescriptors="urn:alm:descriptor:com.tectonic.ui:booleanSwitch"
	...
	// +operator-sdk:csv:customresourcedefinitions:order=11,type=spec,displayName="Manage LTPA",xDescriptors="urn:alm:descriptor:com.tectonic.ui:booleanSwitch"
