...
type WebSphereLibertyApplicationSpec struct {
	...
	// List of Secrets to use to pull images from one or more specified repositories. It is not required if the cluster is configured with a global image pull secret.
	// +operator-sdk:csv:customresourcedefinitions:order=6,type=spec,displayName="Pull Secrets"
	...
	// +operator-sdk:csv:customresourcedefinitions:order=7,type=spec,displayName="Service Account Name",xDescriptors="urn:alm:descriptor:com.tectonic.ui:hidden"
	...
	// +operator-sdk:csv:customresourcedefinitions:order=8,type=spec,displayName="Service Account"
	...
	// +operator-sdk:csv:customresourcedefinitions:order=9,type=spec,displayName="Create Knative Service",xDescriptors="urn:alm:descriptor:com.tectonic.ui:booleanSwitch"
	...
	// +operator-sdk:csv:customresourcedefinitions:order=10,type=spec,displayName="Expose",xDescriptors="urn:alm:descriptor:com.tectonic.ui:booleanSwitch"
	Expose *bool `json:"expose,omitempty"`

	// Enable management of password encryption key sharing amongst Liberty containers. Defaults to false.
	// +operator-sdk:csv:customresourcedefinitions:order=11,type=spec,displayName="Manage Password Encryption",xDescriptors="urn:alm:descriptor:com.tectonic.ui:booleanSwitch"
	...
	// +operator-sdk:csv:customresourcedefinitions:order=12,type=spec,displayName="Manage LTPA",xDescriptors="urn:alm:descriptor:com.tectonic.ui:booleanSwitch"
	ManageLTPA *bool `json:"manageLTPA,omitempty"`

	// Enable management of TLS certificates. Defaults to true.
	// +operator-sdk:csv:customresourcedefinitions:order=13,type=spec,displayName="Manage TLS",xDescriptors="urn:alm:descriptor:com.tectonic.ui:booleanSwitch"
	...
	// +operator-sdk:csv:customresourcedefinitions:order=14,type=spec,displayName="Replicas",xDescriptors="urn:alm:descriptor:com.tectonic.ui:podCount"
	Replicas *int32 `json:"replicas,omitempty"`

	// +operator-sdk:csv:customresourcedefinitions:order=15,type=spec,displayName="Auto Scaling"
	...
	// +operator-sdk:csv:customresourcedefinitions:order=16,type=spec,displayName="Resource Requirements",xDescriptors="urn:alm:descriptor:com.tectonic.ui:resourceRequirements"
	Resources *corev1.ResourceRequirements `json:"resources,omitempty"`

	// +operator-sdk:csv:customresourcedefinitions:order=17,type=spec,displayName="Probes"
	Probes *WebSphereLibertyApplicationProbesConfig `json:"probes,omitempty"`

	// +operator-sdk:csv:customresourcedefinitions:order=18,type=spec,displayName="Deployment"
	Deployment *WebSphereLibertyApplicationDeployment `json:"deployment,omitempty"`

	// +operator-sdk:csv:customresourcedefinitions:order=19,type=spec,displayName="StatefulSet"
	StatefulSet *WebSphereLibertyApplicationStatefulSet `json:"statefulSet,omitempty"`

	// +operator-sdk:csv:customresourcedefinitions:order=20,type=spec,displayName="Service"
	Service *WebSphereLibertyApplicationService `json:"service,omitempty"`

	// +operator-sdk:csv:customresourcedefinitions:order=21,type=spec,displayName="Route"
	...
	// +operator-sdk:csv:customresourcedefinitions:order=22,type=spec,displayName="Semeru Cloud Compiler"
	SemeruCloudCompiler *WebSphereLibertyApplicationSemeruCloudCompiler `json:"semeruCloudCompiler,omitempty"`

	// +operator-sdk:csv:customresourcedefinitions:order=23,type=spec,displayName="Network Policy"
	NetworkPolicy *WebSphereLibertyApplicationNetworkPolicy `json:"networkPolicy,omitempty"`

	// +operator-sdk:csv:customresourcedefinitions:order=24,type=spec,displayName="Serviceability"
	Serviceability *WebSphereLibertyApplicationServiceability `json:"serviceability,omitempty"`

	// +operator-sdk:csv:customresourcedefinitions:order=25,type=spec,displayName="Single Sign-On"
	SSO *WebSphereLibertyApplicationSSO `json:"sso,omitempty"`

	// +operator-sdk:csv:customresourcedefinitions:order=26,type=spec,displayName="Monitoring"
	...
	// +listType=map
	// +listMapKey=name
	// +operator-sdk:csv:customresourcedefinitions:order=27,type=spec,displayName="Environment Variables"
	Env []corev1.EnvVar `json:"env,omitempty"`

	// List of sources to populate environment variables in the application container.
	// +listType=atomic
	// +operator-sdk:csv:customresourcedefinitions:order=28,type=spec,displayName="Environment Variables from Sources"
	EnvFrom []corev1.EnvFromSource `json:"envFrom,omitempty"`

	// Represents a volume with data that is accessible to the application container.
	// +listType=map
	// +listMapKey=name
	// +operator-sdk:csv:customresourcedefinitions:order=29,type=spec,displayName="Volumes"
	Volumes []corev1.Volume `json:"volumes,omitempty"`

	// Represents where to mount the volumes into the application container.
	// +listType=atomic
	// +operator-sdk:csv:customresourcedefinitions:order=30,type=spec,displayName="Volume Mounts"
	VolumeMounts []corev1.VolumeMount `json:"volumeMounts,omitempty"`

	// List of containers to run before other containers in a pod.
	// +listType=map
	// +listMapKey=name
	// +operator-sdk:csv:customresourcedefinitions:order=31,type=spec,displayName="Init Containers"
	InitContainers []corev1.Container `json:"initContainers,omitempty"`

	// List of sidecar containers. These are additional containers to be added to the pods.
	// +listType=map
	// +listMapKey=name
	// +operator-sdk:csv:customresourcedefinitions:order=32,type=spec,displayName="Sidecar Containers"
	SidecarContainers []corev1.Container `json:"sidecarContainers,omitempty"`

	// +operator-sdk:csv:customresourcedefinitions:order=33,type=spec,displayName="Affinity"
	Affinity *WebSphereLibertyApplicationAffinity `json:"affinity,omitempty"`

	// Security context for the application container.
	// +operator-sdk:csv:customresourcedefinitions:order=34,type=spec,displayName="Security Context"
	SecurityContext *corev1.SecurityContext `json:"securityContext,omitempty"`

	// +operator-sdk:csv:customresourcedefinitions:order=35,type=spec,displayName="Topology Spread Constraints"
	...
	// +operator-sdk:csv:customresourcedefinitions:order=36,type=spec,displayName="Disable Service Links",xDescriptors="urn:alm:descriptor:com.tectonic.ui:booleanSwitch"
	...
	// +operator-sdk:csv:customresourcedefinitions:order=37,type=spec,displayName="Tolerations"
	Tolerations []corev1.Toleration `json:"tolerations,omitempty"`

	// DNS settings for the application pod.
	// +operator-sdk:csv:customresourcedefinitions:order=38,type=spec,displayName="DNS"
...
// GetPullSecrets returns the secret list for additional docker registry credentials
func (cr *WebSphereLibertyApplication) GetPullSecrets() []string {
	return cr.Spec.PullSecrets
}
