...
build_script_branch="build-script"
build_script_folder_url="https://api.github.ibm.com/repos/websphere/operators/contents/scripts/build?ref=${build_script_branch}"
...
for build_script in "${build_scripts[@]}"; do
    build_script_url="https://api.github.ibm.com/repos/websphere/operators/contents/scripts/build/${build_script}?ref=${build_script_branch}"
