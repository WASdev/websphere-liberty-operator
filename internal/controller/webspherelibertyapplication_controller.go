...
func (r *ReconcileWebSphereLiberty) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	if instance.Spec.StatefulSet != nil {
		...
		err = r.CreateOrUpdate(statefulSet, instance, func() error {
			...
			if r.isPasswordEncryptionKeySharingEnabled(instance) && encryptionSecretName != "" {
			...
			if r.isLTPAKeySharingEnabled(instance) && ltpaSecretName != "" {
...
func (r *ReconcileWebSphereLiberty) IsLibertyVersionCheckNeeded(instance *webspherelibertyv1.WebSphereLibertyApplication) bool {
...
func (r *ReconcileWebSphereLiberty) getContainerImageMetadata(reqLogger logr.Logger, wlapp *webspherelibertyv1.WebSphereLibertyApplication, imageRef imagev1.DockerImageReference) (string, *runtime.RawExtension, error) {
	...
	if r.IsOpenShift() {
		return libertyimage.NewNamespaceCredentialsContextWithTransport(reqLogger, wlappSecrets, wlapp.GetNamespace(), libertyimage.ClusterCATransport(), nil).GetContainerImageMetadata(context.TODO(), imageRef, pullSecret, false)
	}
